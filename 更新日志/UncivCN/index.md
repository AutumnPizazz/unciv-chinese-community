...
## v4.21.0.1<Badge type="tip" text="最新" />

**发布日期**：2026.8.1

- 跟进Unciv原版近期更新

> 由于UncivCN与Unciv原版都对胜利面板作类似功能性改动，回退`禁用文明积分面板时同步禁用实验性统计面板`功能，以Unciv原版为准

- 补全缺失的中文本地化

- 联机默认服务器改为`http://sp.unciv.cn:30123`

- 调整Unciv原版的人口锁定工作地块快捷方式，选中人口时城市屏幕右下角新增“自动锁定”按钮**永久切换**不锁人口/锁人口
